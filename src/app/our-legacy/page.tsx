...
const EXPERTISE_METRICS = [
  {
    discipline: "HVAC Infrastructure",
    icon: Wind,
    capability: "98%",
    summary: "Centralized chiller loops & precision cleanroom air handling vectors.",
  },
  {
    discipline: "Cryogenic Engineering",
    icon: Snowflake,
    capability: "94%",
    summary: "Ultra-low temperature liquid distribution vacuum jacketed piping.",
  },
  {
    discipline: "Fire Fighting Matrices",
    icon: Flame,
    capability: "96%",
    summary: "Automated high-velocity water deluge & chemical foam arrays.",
  },
  {
    discipline: "Electrical Systems",
    icon: Zap,
    capability: "92%",
    summary: "HT/LT panels, transformer allocation, & grid load synchronization.",
  },
  {
    discipline: "Project Management",
    icon: Briefcase,
    capability: "99%",
    summary: "Turnkey delivery, parametric risk monitoring, & resource timeline lock.",
  },
];
...
const CORPORATE_VALUES = [
  {
    ...
    icon: FileCheck,
    description: "Uncompromised build standards following international ISO and ASME guidelines.",
  },
  {
    name: "Zero-Fail Safety",
    icon: ShieldCheck,
    description: "Instilling strict structural protocols to guarantee lifetime asset reliability.",
  },
  {
    name: "Ironclad Commitment",
    icon: Clock,
    description:
      "Delivering massive industrial arrays strictly inside projected timeframe parameters.",
  },
  {
    name: "Agile Innovation",
    icon: TrendingUp,
    description:
      "Integrating cloud automation, thermodynamic telemetry, and smart energy optimization.",
  },
  {
    name: "Operational Reliability",
    icon: Compass,
    description:
      "Forging lifetime engineering assets through continuous preventative monitoring structures.",
  },
  {
    name: "Client Synchronization",
    icon: HeartHandshake,
    description: "Formulating custom tailored master plans that cleanly adapt to site realities.",
  },
];
...
const PremiumGlassCard = ({
  ...
  <div
    className={`bg-[#160E0E]/40 border border-[#EBCDCB]/10 backdrop-blur-xl rounded-sm p-6 sm:p-8 relative overflow-hidden group hover:border-[#981618]/50 transition-all duration-500 ${className}`}
  >
      ...
      >
          ...
          <div className="lg:col-span-6 flex flex-col justify-center space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm sm:text-base font-light leading-relaxed text-[#A27273]">
                SP Engineering's industrial infrastructure roots are anchored by decades of
                unyielding execution metrics. Masterminded by enterprise-focused engineering
                leadership, we deploy optimized turn-key safety arrays and environmental control
                architectures across global mechanical corridors.
              </p>
              <p className="text-xs sm:text-sm font-light leading-relaxed text-[#A27273]/80">
                From localized thermodynamic management parameters to massive sub-zero vacuum
                containment solutions, our operational timeline is built with zero room for error.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className="border-l border-[#981618] pl-3">
                ...
                <span className="text-[10px] uppercase text-[#A27273] tracking-wider font-semibold">
                  Industrial Mastery
                </span>
              </div>
              <div className="border-l border-[#981618] pl-3">
            ...
            <div className="pt-4 flex flex-wrap gap-4">
              <a
                href="#timeline-matrix"
                className="px-6 py-3.5 bg-[#981618] text-white text-xs font-bold uppercase tracking-[0.2em] rounded-sm shadow-[0_0_20px_rgba(152,22,24,0.3)] hover:shadow-[0_0_35px_rgba(152,22,24,0.6)] transition-all flex items-center gap-2"
              >
                Explore Timeline Matrix <ArrowRight className="w-3.5 h-3.5" />
              </a>
              <a
                href="/contact"
                className="px-6 py-3.5 bg-transparent border border-[#EBCDCB]/20 text-white text-xs font-bold uppercase tracking-[0.2em] rounded-sm hover:border-[#981618] transition-all"
              >
          ...
          <div className="lg:col-span-6 relative group w-full lg:max-w-xl lg:justify-self-end">
            ...
            <div className="relative aspect-[4/5] sm:aspect-[16/14] lg:aspect-[4/5] bg-neutral-900 border border-[#EBCDCB]/10 rounded-sm overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 z-20">
                <h4 className="text-white font-mono text-xl font-bold tracking-wide">
                  Mr. Pradeep Upadhyay
                </h4>
                <span className="text-[#981618] text-[10px] uppercase tracking-widest font-bold font-mono block mt-0.5">
                  Managing Director & Chief Visionary
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 mb-32 grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          <PremiumGlassCard className="lg:col-span-1 flex flex-col justify-between border-l-2 border-l-[#981618]">
            <div>
              <span className="text-[10px] font-mono uppercase text-[#981618] tracking-widest block mb-2">
                Core Ethos
              </span>
              ...
              <p className="text-xs sm:text-sm text-[#A27273] font-light leading-relaxed">
                "True industrial validation is achieved when mechanical configuration complexity
                transitions seamlessly into operational safety. We do not simply mount pipelines; we
                anchor structural safety matrix networks designed to endure generations."
              </p>
            </div>
            <div className="pt-6 border-t border-[#EBCDCB]/5 mt-6">
              <div className="text-xs text-white/40 font-mono italic">
                Operational System Signature Verified
              </div>
            </div>
          </PremiumGlassCard>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              {
                value: "15+",
                metric: "Years Active Field Mastery",
                desc: "Direct oversight of volatile refinery environments.",
                icon: Award,
              },
              {
                value: "240+",
                metric: "Commissioned Project Vectors",
                desc: "Turnkey handovers without parameter variance.",
                icon: CheckCircle,
              },
              {
                value: "12+",
                metric: "Distinct Enterprise Sectors",
                desc: "From sub-zero cryo loops to high-voltage hubs.",
                icon: Briefcase,
              },
              {
                value: "100%",
                metric: "Regulatory Compliance Metric",
                desc: "Absolute NBC, ISO, and safety compliance.",
                icon: FileCheck,
              },
            ].map((stat, i) => (
              <div
                key={i}
                className="bg-[#160E0E]/60 border border-[#EBCDCB]/5 p-6 rounded-sm group hover:border-[#981618]/30 transition-all flex flex-col justify-between"
              >
                <div>
                  <stat.icon className="w-5 h-5 text-[#981618] mb-3 group-hover:scale-110 transition-transform" />
                  <div className="text-2xl sm:text-4xl font-black text-white font-mono tracking-tight mb-1">
                    {stat.value}
                  </div>
                  <div className="text-[10px] uppercase tracking-widest font-bold text-[#EBCDCB] mb-2">
                    {stat.metric}
                  </div>
                </div>
            ...
            {TIMELINE_STEPS.map((step, idx) => (
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  <span className="font-mono text-[10px] text-[#A27273] font-bold tracking-widest uppercase">
                    {step.era}
                  </span>
                  <div
                    className={`w-2 h-2 rounded-full ${activeTimeline === idx ? "bg-[#981618] shadow-[0_0_8px_#981618]" : "bg-neutral-800"}`}
                  />
                </div>
                ...
                <PremiumGlassCard key={i} className="flex flex-col justify-between min-h-48">
                  <div>
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className="font-mono text-sm font-bold text-[#981618]">
                        {exp.capability}
                      </span>
                    </div>
                    ...
                    <p className="text-xs text-[#A27273] leading-relaxed font-light">
                      {exp.summary}
                    </p>
                  </div>
                  <div className="w-full h-[1px] bg-neutral-900 mt-6 relative overflow-hidden">
                    <div
                      className="absolute top-0 left-0 h-full bg-[#981618]"
                      style={{ width: exp.capability }}
                    />
                  </div>
                </PremiumGlassCard>
              );
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {CORPORATE_VALUES.map((val, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-6 bg-[#160E0E]/40 border border-[#EBCDCB]/5 hover:border-[#981618]/30 transition-all rounded-sm group flex gap-4"
                >
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-[#A27273] leading-relaxed font-light">
                      {val.description}
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-[#160E0E]/90 border border-[#EBCDCB]/10 p-8 sm:p-14 rounded-sm relative backdrop-blur-md">
              ...
              <div className="space-y-6 text-center relative z-10">
                ...
                <p className="text-sm sm:text-lg text-white font-light italic leading-relaxed max-w-2xl mx-auto">
                  "Our history isn't documented purely by balance sheets; it's forged deep inside
                  the structural integrity of every localized ventilation manifold and cryogenic
                  containment skid we have commissioned since our genesis. We engineer
                  infrastructure parameters so your business executes safely."
                </p>

                <div className="pt-4">
                  <div className="text-sm font-bold tracking-wide text-white font-sans">
                    Mr. Pradeep Upadhyay
                  </div>
        ...
        <div className="relative z-10 bg-gradient-to-b from-[#160E0E]/80 to-[#221011]/80 border border-[#981618]/40 p-10 sm:p-16 rounded-sm text-center shadow-[0_0_50px_rgba(152,22,24,0.15)] mb-12">
          ...
          <p className="text-xs sm:text-sm text-[#A27273] max-w-xl mx-auto mb-8 font-light leading-relaxed">
            Unlock high-grade parametric calibration for your next industrial infrastructure asset
            deployment. Contact our executive office.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="/contact"
              className="px-8 py-3.5 bg-[#981618] text-white font-semibold text-xs tracking-widest uppercase rounded-sm hover:bg-[#7d1214] transition-colors"
            >
