...
function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-5 lg:px-8 relative z-10 py-8">
        {/* ========================================================
        ...
        >
          ...
          <ul className="mt-7 grid sm:grid-cols-2 gap-3">
            {[
              ...
              <li key={item} className="flex items-center gap-3 rounded-xl glass px-4 py-3 text-sm">
...
function Services() {
  return (
    <Section
      ...
      title={
        <>
          Four disciplines. <span className="text-brand-gradient">One trusted partner.</span>
        </>
      }
...
const STEPS = [
  {
    n: "01",
    title: "Consultation",
    desc: "Discover your goals, site constraints and load requirements.",
  },
