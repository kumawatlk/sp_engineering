    ...
    features: [
      {
        ...
        desc: "Custom AHU design, ducting, and balancing tuned to your load profile.",
      },
      {
        icon: ThermometerSnowflake,
        title: "Chiller Plants",
        desc: "Water and air-cooled chiller installation, piping, and commissioning.",
      },
      {
        icon: Activity,
        title: "BMS Integration",
        desc: "Smart controls and monitoring for centralized HVAC management.",
      },
      {
        icon: Wrench,
        title: "Retrofit & AMC",
        desc: "Performance upgrades and annual maintenance contracts.",
      },
    ],
    applications: [
    ...
    features: [
      {
        icon: Droplets,
        title: "Storage Tanks",
        desc: "Vacuum-insulated tank installation and validation.",
      },
      {
        icon: Settings,
        title: "Vaporizers & Piping",
        desc: "Ambient and electric vaporizers with cryo-piping networks.",
      },
      {
        icon: ShieldCheck,
        title: "Safety Systems",
        desc: "PSV, oxygen monitoring, and emergency shut-off integration.",
      },
      {
        icon: Wrench,
        title: "Maintenance",
        desc: "Leak testing, recertification, and overhaul services.",
      },
    ],
    applications: [
    ...
    features: [
      {
        ...
        desc: "Wet, dry, and pre-action sprinkler networks.",
      },
      {
        icon: Siren,
        title: "Detection & Alarm",
        desc: "Addressable fire alarm, smoke & heat detection.",
      },
      {
        icon: ShieldCheck,
        title: "Gas Suppression",
        desc: "FM-200, Novec 1230, and CO₂ systems for critical zones.",
      },
      {
        icon: Wrench,
        title: "Pump Rooms",
        desc: "Jockey, electric & diesel pump installation per NFPA 20.",
      },
    ],
    applications: [
    ...
    features: [
      {
        icon: Plug,
        title: "LT & HT Panels",
        desc: "Custom switchboards, PCC, MCC, and APFC panels.",
      },
      {
        icon: CircuitBoard,
        title: "Cabling & Trays",
        desc: "Power, control, and instrumentation cabling.",
      },
      {
        icon: ShieldCheck,
        title: "Earthing & LPS",
        desc: "Maintenance-free earthing and lightning protection.",
      },
      {
        icon: Activity,
        title: "Automation",
        desc: "PLC, SCADA, and IoT-based monitoring integration.",
      },
    ],
    applications: [
...
function ServicesHero() {
  return (
    <section className="relative isolate overflow-hidden pt-32 pb-24 md:pt-8 md:pb-32">
      <AnimatedBackground />
      ...
      <div className="container relative mx-auto px-5 lg:px-8">
        ...
        <motion.div initial="hidden" animate="show" variants={fadeUp} className="max-w-4xl">
          ...
          <p className="mt-7 max-w-2xl text-lg md:text-xl text-muted-foreground leading-relaxed">
            From climate-critical HVAC to high-stakes cryogenic and fire safety systems — SP
            Engineering delivers integrated industrial solutions with uncompromising quality and
            on-time execution.
          </p>
        ...
        >
          ...
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <a href="/contact">
                <AnimatedButton icon={<ArrowRight className="h-4 w-4" />}>
                  Get a Proposal
                </AnimatedButton>
              </a>
              <a href="/projects">
...
function SubHeading({
  ...
  return (
    <div className={compact ? "mb-6" : "mb-10"}>
      ...
      <h3
        className={`mt-2 font-bold tracking-tight ${compact ? "text-2xl" : "text-3xl md:text-4xl"}`}
      >
        {title}
      </h3>
    </div>
