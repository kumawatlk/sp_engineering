...
export function LegacySection() {
  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y: bgY }} className="absolute inset-0 z-0 opacity-30">
          ...
          >
            ...
            <div className="relative bg-[#160E0E]/40 border border-[#EBCDCB]/10 backdrop-blur-xl p-8 sm:p-12 rounded-sm shadow-2xl">
              ...
              <p className="text-[#A27273] text-sm sm:text-base leading-relaxed mb-10 font-light max-w-lg">
                SP Engineering is built on years of industrial expertise, technical excellence, and
                commitment to quality engineering solutions across HVAC, Cryogenic, Fire Fighting,
              ...
              <div className="grid grid-cols-2 gap-4 mb-10">
                {stats.map((stat, i) => (
                  <div
                    key={i}
                    className="p-4 bg-[#160E0E]/60 border border-[#EBCDCB]/5 rounded-sm group hover:border-[#981618]/40 transition-colors"
                  >
                    <stat.icon className="w-5 h-5 text-[#981618] mb-2" />
                    <div className="text-lg font-bold text-white font-mono">{stat.value}</div>
                    <div className="text-[9px] uppercase tracking-wider text-[#A27273]">
                      {stat.label}
                    </div>
                  </div>
                ))}
          ...
          >
            ...
            <div className="relative aspect-[4/5] overflow-hidden rounded-sm shadow-2xl">
              ...
              <div className="absolute bottom-8 left-8 z-20">
                ...
                <div className="text-[#981618] text-xs font-mono uppercase tracking-widest font-bold">
                  Managing Director
                </div>
              </div>
            </div>
