...
export function ServiceCard({ icon: Icon, title, description, index = 0, className }: ServiceCardProps) {
  return (
    <motion.article
      ...
      className={cn(
        "group relative overflow-hidden rounded-2xl glass p-7 hover-lift",
        className,
      )}
    >
