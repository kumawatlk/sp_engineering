...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "About SP Engineering — Trusted Industrial Engineering Partner" },
      {
        name: "description",
        content:
          "SP Engineering is a reliable technical service provider delivering industrial and commercial engineering projects with quality, safety, and on-time execution.",
      },
      { property: "og:title", content: "About SP Engineering" },
      {
        property: "og:description",
        content:
          "Skilled team, modern tools, certified processes and customer-first delivery across India.",
      },
...
const HIGHLIGHTS = [
  { icon: Users, title: "Skilled & Experienced Team", desc: "Certified engineers and technicians with decades of combined field expertise." },
  { icon: Cpu, title: "Latest Tools & Technology", desc: "Modern equipment, calibrated instruments and digital workflows for precision." },
  { icon: Clock, title: "On-Time Project Completion", desc: "Disciplined planning and execution to honour every milestone and deadline." },
  { icon: HeartHandshake, title: "Customer Satisfaction Guaranteed", desc: "Transparent communication and quality assurance from kick-off to handover." },
];

const EXPERTISE = [
  { icon: Wrench, title: "Industrial Fabrication", desc: "Heavy-duty fabrication for plants, refineries and process industries." },
  { icon: Gauge, title: "Precision Engineering", desc: "Tight-tolerance machining, assembly and quality-controlled deliverables." },
  { icon: Factory, title: "Turnkey Projects", desc: "End-to-end delivery — design, supply, installation, testing and commissioning." },
  { icon: HardHat, title: "Plant Maintenance", desc: "Preventive, predictive and breakdown maintenance with rapid response." },
];
...
const TRUST = [
  { icon: ShieldCheck, title: "Reliability First", desc: "We deliver what we commit — predictable timelines and predictable quality." },
  { icon: Award, title: "Premium Standards", desc: "Materials, workmanship and finishing held to the highest industrial benchmarks." },
  { icon: BadgeCheck, title: "Documented Quality", desc: "Inspection reports, test certificates and full traceability with every project." },
];
...
const TIMELINE = [
  { year: "2012", title: "Founded", desc: "SP Engineering established with a focus on industrial fabrication services." },
  { year: "2015", title: "Expanded Capabilities", desc: "Added HVAC, electrical and plant maintenance verticals to the portfolio." },
  { year: "2018", title: "100+ Projects Milestone", desc: "Crossed 100 successful project deliveries across Maharashtra and beyond." },
  { year: "2021", title: "Certified Processes", desc: "Adopted ISO-aligned quality and safety management systems across operations." },
  { year: "2024", title: "Pan-India Reach", desc: "Serving manufacturing, pharma, hospitality and infrastructure clients nationwide." },
];
...
const TEAM = [
  ...
  { name: "Skilled Technicians", role: "Fabrication, installation & commissioning", img: aboutPreview },
];
  ...
  return (
    <main>
        ...
        <div className="container relative mx-auto px-5 lg:px-8">
          ...
          >
            ...
            <h1 className="mt-6 text-5xl md:text-7xl font-bold tracking-tight leading-[1.05]">
              Engineering trust,{" "}
              <span className="text-brand-gradient">built to last.</span>
            </h1>
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-2xl">
              SP Engineering is a reliable and experienced technical service provider
              specializing in industrial and commercial engineering projects — with a
        ...
        <div className="grid gap-12 lg:grid-cols-2 items-center">
          ...
          >
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              From precision fabrication to complete turnkey installations, SP Engineering
              brings together skilled craftsmanship, modern tooling and rigorous safety
              culture to deliver dependable engineering outcomes for industry leaders.
            </p>
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              We operate as a long-term partner — engineering systems that perform under
              real-world pressure and standing behind every weld, every wire and every
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {HIGHLIGHTS.map((h, i) => (
            ...
            >
              ...
              <div className="relative">
                <div className="inline-grid h-12 w-12 place-items-center rounded-xl bg-gradient-brand glow-brand-sm">
      ...
      <Section
        ...
        title="Capabilities engineered for industrial demand."
      >
        <div className="grid gap-6 md:grid-cols-2">
          {EXPERTISE.map((e, i) => (
            ...
            >
              <div className="inline-grid h-14 w-14 shrink-0 place-items-center rounded-xl bg-gradient-brand glow-brand-sm">
      ...
      <Section eyebrow="Safety First" title="A culture of zero compromise.">
        <div className="grid gap-12 lg:grid-cols-2 items-center">
          ...
          >
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              Safety is not a checklist for us — it is a discipline embedded into every
              project, from kickoff to handover. Our teams operate under documented HSE
              protocols and statutory compliance.
            </p>
      ...
      {/* CERTIFICATIONS */}
      <Section eyebrow="Certifications & Compliance" title="Credentials that back our work." centered>
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {CERTS.map((c, i) => (
            ...
            >
              ...
              <div className="relative">
                <div className="mx-auto inline-grid h-14 w-14 place-items-center rounded-full bg-gradient-brand glow-brand-sm">
      ...
      <Section eyebrow="Why Clients Trust Us" title="Engineering you can take to the bank." centered>
