...
function Page() {
  ...
  return (
    ...
    >
      ...
      >
        {/* PHONE CARD */}
        <motion.div variants={fadeInUp} className="group relative bg-[#160E0E]/40 border border-[#EBCDCB]/10 p-8 rounded-sm backdrop-blur-xl transition-all duration-500 hover:border-[#981618]/50 hover:shadow-[0_0_40px_rgba(152,22,24,0.15)] flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-md font-bold tracking-wider uppercase text-white mb-2">Voice Comms</h3>
            <p className="text-xs text-[#A27273] mb-4">Available for critical escalations</p>
            <div className="space-y-2 text-sm">
              <div className="flex items-center justify-between">
                <a href="tel:+918097604693" className="text-[#EBCDCB] hover:text-[#981618] font-mono transition-colors">+91 80976 04693</a>
                <button onClick={() => handleCopy("+918097604693", "p1")} className="text-[#A27273] hover:text-white transition-colors">
                  {copiedText === "p1" ? <Check className="w-3.5 h-3.5 text-green-500" /> : <Copy className="w-3.5 h-3.5" />}
                </button>
              </div>
              <div className="flex items-center justify-between">
                <a href="tel:+918552077798" className="text-[#EBCDCB] hover:text-[#981618] font-mono transition-colors">+91 85520 77798</a>
                <button onClick={() => handleCopy("+918552077798", "p2")} className="text-[#A27273] hover:text-white transition-colors">
                  {copiedText === "p2" ? <Check className="w-3.5 h-3.5 text-green-500" /> : <Copy className="w-3.5 h-3.5" />}
                </button>
              </div>
            </div>
          </div>
        ...
        <motion.div variants={fadeInUp} className="group relative bg-[#160E0E]/40 border border-[#EBCDCB]/10 p-8 rounded-sm backdrop-blur-xl transition-all duration-500 hover:border-[#981618]/50 hover:shadow-[0_0_40px_rgba(152,22,24,0.15)] flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-md font-bold tracking-wider uppercase text-white mb-2">Correspondence</h3>
            <p className="text-xs text-[#A27273] mb-4">For formal technical RFQs</p>
            <div className="flex items-center justify-between text-sm">
              <a href="mailto:spengineering185@gmail.com" className="text-[#EBCDCB] hover:text-[#981618] font-mono break-all text-xs transition-colors">
                spengineering185@gmail.com
              </a>
              <button onClick={() => handleCopy("spengineering185@gmail.com", "email")} className="text-[#A27273] hover:text-white ml-2 transition-colors">
                {copiedText === "email" ? <Check className="w-3.5 h-3.5 text-green-500" /> : <Copy className="w-3.5 h-3.5" />}
              </button>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div variants={fadeInUp} className="group relative bg-[#160E0E]/40 border border-[#EBCDCB]/10 p-8 rounded-sm backdrop-blur-xl transition-all duration-500 hover:border-[#981618]/50 hover:shadow-[0_0_40px_rgba(152,22,24,0.15)] flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-md font-bold tracking-wider uppercase text-white mb-2">Corporate HQ</h3>
            <p className="text-[11px] text-[#EBCDCB]/80 leading-relaxed font-sans">
              10th Floor, Lotus Building, Flat No.1001, Deep Garden, Chedha Nagar, Nalasopara East, Vasai - 401209
            </p>
          </div>
        </motion.div>
        ...
        <motion.div variants={fadeInUp} className="group relative bg-[#160E0E]/40 border border-[#EBCDCB]/10 p-8 rounded-sm backdrop-blur-xl transition-all duration-500 hover:border-[#981618]/50 hover:shadow-[0_0_40px_rgba(152,22,24,0.15)] flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-md font-bold tracking-wider uppercase text-white mb-2">Compliance</h3>
            <div className="flex items-center justify-between bg-[#160E0E] p-2.5 rounded border border-[#EBCDCB]/5 font-mono text-xs">
              ...
              <button onClick={() => handleCopy("27ALFPU1008A1ZL", "gst")} className="text-[#A27273] hover:text-white transition-colors">
                {copiedText === "gst" ? <Check className="w-3.5 h-3.5 text-green-500" /> : <Copy className="w-3.5 h-3.5" />}
              </button>
            </div>
          </div>
        </motion.div>
      ...
      >
        <div className="text-center mb-12">
          <h2 className="text-xs uppercase tracking-[0.25em] text-[#981618] font-bold mb-3">Core Capabilities</h2>
          <p className="text-xl sm:text-3xl font-bold text-white tracking-tight">Select Systems Required for Procurement</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { name: "HVAC Systems", icon: Wind, desc: "Industrial climate optimization & complex ventilation systems." },
            { name: "Cryogenic Services", icon: Snowflake, desc: "Ultra-low temperature infrastructure & vacuum pipelines." },
            { name: "Fire Fighting", icon: Flame, desc: "Integrated automated suppression & safety arrays." },
            { name: "Electrical Services", icon: Zap, desc: "High voltage distribution & industrial panel design." }
          ].map((service, idx) => {
            ...
            return (
              ...
              >
                <div>
                  <div className={`w-10 h-10 flex items-center justify-center rounded-sm border mb-4 ${
                    isSelected ? "bg-[#981618] border-none text-white" : "bg-[#160E0E] border-[#EBCDCB]/10 text-[#A27273]"
                  }`}>
                    <IconComp className="w-5 h-5" />
                  </div>
                  <h3 className="text-base font-semibold text-white tracking-wide mb-1">{service.name}</h3>
      ...
      <div id="inquiry-form" className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start mb-28 relative z-10">
        <motion.div 
        ...
        >
          <div className="border-l-2 border-[#981618] pl-4">
            <span className="text-xs uppercase tracking-widest text-[#981618] font-bold block mb-1">Project Deployment</span>
            <h2 className="text-2xl font-bold text-white tracking-tight">Submit Engineering Brief</h2>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder=" "
                />
                <label className={`absolute left-4 top-3.5 text-sm text-[#A27273] pointer-events-none transition-all origin-left 
              ...
              <div className="relative">
                ...
                >
                  <option value="" disabled>Select Core System Discipline</option>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full bg-[#160E0E] border border-[#EBCDCB]/10 rounded-sm px-4 py-3.5 text-white focus:outline-none focus:border-[#981618] transition-all text-sm appearance-none"
                >
                  <option value="" disabled>Project Infrastructure Type</option>
            ...
            <AnimatePresence>
              {submitSuccess && (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-white uppercase tracking-wider mb-1">Transmission Successful</h3>
                  <p className="text-xs text-[#A27273] max-w-sm">Data safely logged. Technical team will verify shortly.</p>
                </motion.div>
              )}
            </AnimatePresence>
          </form>
      ...
      >
        <div className="text-center mb-16">
          <h2 className="text-xs uppercase tracking-[0.25em] text-[#981618] font-bold mb-2">Operational Flow</h2>
          <p className="text-xl sm:text-3xl font-bold text-white tracking-tight">Execution Roadmap</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          {[
            { step: "01", name: "Secure Intake", desc: "Digital design specs processed securely." },
            { step: "02", name: "Site Inspection", desc: "Physical mapping and load calibrations verification." },
            { step: "03", name: "Quotation Delivery", desc: "Parametric calculations bills of material deployed." },
            { step: "04", name: "Execution Deploy", desc: "Precision deployment managed under field experts." }
          ].map((proc, idx) => (
            <motion.div key={idx} variants={fadeInUp} className="bg-[#160E0E]/50 border border-[#EBCDCB]/5 p-6 rounded-sm hover:border-[#981618]/30 transition-all">
              <span className="font-mono text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#981618] to-transparent block mb-2">{proc.step}</span>
      ...
      >
        <div className="text-center mb-12">
          <h2 className="text-xs uppercase tracking-[0.25em] text-[#981618] font-bold mb-2">Knowledge Base</h2>
          <p className="text-xl sm:text-3xl font-bold text-white tracking-tight">Technical Resolution Matrix</p>
        </div>

        <div className="space-y-4">
          {[
            { q: "What is your standard mobilization timeline for industrial site inspections?", a: "For facilities located within regional hubs, engineering crews deploy within 24 to 48 hours." },
            { q: "Do you offer ongoing Annual Maintenance Contracts (AMC)?", a: "Yes, SP Engineering manages long-term preventative compliance metrics through automated priority AMCs." },
            { q: "Can your fire fighting arrays integrate with legacy BMS systems?", a: "Our electrical engineering divisions build specialized relays to bridge safety arrays into legacy code environments seamlessly." }
          ].map((faq, index) => (
            <div key={index} className="border border-[#EBCDCB]/10 rounded-sm bg-[#160E0E]/30 overflow-hidden">
              <button
                onClick={() => setActiveFaq(activeFaq === index ? null : index)}
                className="w-full px-6 py-4 text-left flex justify-between items-center bg-[#160E0E]/40"
              >
                <span className="text-xs sm:text-sm font-semibold text-white tracking-wide">{faq.q}</span>
                <motion.div animate={{ rotate: activeFaq === index ? 180 : 0 }} className="text-[#981618]">
      ...
      <div className="relative bg-gradient-to-b from-[#160E0E]/80 to-[#221011]/80 border border-[#981618]/40 p-8 sm:p-12 rounded-sm text-center shadow-[0_0_50px_rgba(152,22,24,0.15)] mb-12 z-10">
        <h2 className="text-2xl sm:text-4xl font-bold text-white tracking-tight mb-4">Ready To Start Your Engineering Project?</h2>
        <div className="flex flex-wrap justify-center gap-4">
          <a href="tel:+918097604693" className="px-6 py-3 bg-[#981618] text-white font-semibold text-xs tracking-widest uppercase rounded-sm">
